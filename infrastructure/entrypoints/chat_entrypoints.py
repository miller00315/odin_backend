...
@router.get("/get_status/", summary="This is the endpoitn where the messages will be added")
...
@router.get("/get_messages/", summary="This is the endpoint that returns teh messages")
async def get_response(
    chat_uuid: str,
    usecase: ChatUsecase = Depends(get_chat_usecase)
):
...
@router.get("/get_last_messages/", summary="This is the endpoint that returns teh messages")
async def get_response(
    chat_uuid: str,
    message_uuid: str,
    usecase: ChatUsecase = Depends(get_chat_usecase)
